...
import { Heart, Target, Zap, ChevronRight, Info, AlertTriangle, ExternalLink, Cross, Swords } from "lucide-react";
    ...
    <main style={{ maxWidth: "1000px", margin: "0 auto", padding: "6rem 1.5rem 4rem" }}>
      ...
      <header style={{ marginBottom: "3rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "2rem" }}>
          ...
          <div>
            <h1 style={{ fontSize: "2.5rem", fontWeight: 900, color: "#1e293b", margin: 0 }}>Priest Academy</h1>
            <p style={{ color: "#64748b", margin: 0, fontWeight: 600 }}>Mastering Support, Holy Arts, and Combat</p>
          </div>
        </div>
