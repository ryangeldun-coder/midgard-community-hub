...
import { Hammer, Scroll, FlaskConical, Bug, Sword, Wrench } from "lucide-react";
    ...
    <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
      ...
      <section style={{ padding: '4rem 0', borderTop: '1px solid #f1f5f9' }}>
        <p style={{ color: '#64748b', fontSize: '0.9rem', lineHeight: '1.8', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          Welcome to the <strong>Midgard Community Hub</strong>, your premier destination for everything <strong>Ragnarok Zero Global (TWRoZ)</strong>. Our platform provides an extensive <strong>Ragnarok Zero database</strong> featuring accurate monster stats, drop tables, and item locations translated directly into English. Whether you're looking for a <strong>refine simulator</strong> to test your luck with Zelunium and Shadowdecon, a <strong>Blacksmith forge calculator</strong> for high-level weapon crafting, or <strong>Alchemist brewing rates</strong>, our tools are designed to optimize your gameplay. Join the community led by <strong>Ryan Geldun</strong> and dive deep into the <strong>Ragnarok Online lore</strong> with our curated video archives. Stay ahead of the game with the most reliable Ragnarok Zero tools and information available today.
        </p>
      </section>
    </main>
  );
